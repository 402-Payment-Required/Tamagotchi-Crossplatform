...
Violation examples:
```ts
// entity/pet/model/usePet.ts
import { PetCard } from '~/widget/pet/ui/PetCard'; // ✗ upward import
import { useInventory } from '~/entity/inventory/model/useInventory'; // ✗ cross-layer
```
...
```ts
// ✓ src/entity/pet/index.ts
export { usePet } from './model/usePet';
export { PetCard } from './ui/PetCard';
export type { PetResponse } from './api/getPet';
```
